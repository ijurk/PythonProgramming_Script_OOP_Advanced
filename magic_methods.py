# 1. In the following class, write code for the methods __eq__
# , __lt__, __le__.
class Time:
    ...
    def __eq__(self, other):
        return True if self._cmp(other) == 0 else False

    def __lt__(self, other):
        return True if self._cmp(other) == 1 else False

    def __le__(self,other):
        return True if (self._cmp(other) == 1 or self._cmp(other) == 0) else False
